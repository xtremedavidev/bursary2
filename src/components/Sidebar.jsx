...
export default function Sidebar() {
    return (
      <div className="hidden md:flex w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex-1 flex flex-col min-h-0 bg-gray-800">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex mx-auto px-4">
              <img className="h-12 p-2 rounded-full w-auto bg-white" src="https://i0.wp.com/freepnglogo.net/assets/uploads/2023/05/OAU-Logo-PNG.png?w=500&ssl=1" alt="Workflow" />
            </div>
            <nav className="mt-5 flex-1 px-2 space-y-1">
              ...
              <a href="/ReportsPage" className="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
